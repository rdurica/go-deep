...
Po přečtení teorie spusť v Cursoru **`/go-deep-quiz 32`**. AI tě ~5 minut prověří mentální model (ne hotové cvičení). Slabiny si uloží do [`GAPS.md`](../../GAPS.md).
...
Pak **`/go-deep-review 32 hard`**.

Až budou stupně hotové, porovnej se `solutions/` (spoiler).

## Závěrečné otázky

Spusť **`/go-deep-review 32 final`**. AI projde body níže, doptá se a ověří pochopení. Celé cvičení ověří `make lesson L=32` (+ `make race L=32`, pokud to lekce vyžaduje).
